...
<html>
    ...
    <div class="sidenav">
      ...
      <center>
      <div class="container">
        <b><i>Close Account</i></b>
        <br><br>
        <center>
        <form action="close_acc_process.php" method="POST">

          Account ID:<br> <input type="number" placeholder="Account ID" name="aid"><br><br>
          Customer ID:<br> <input type="number" placeholder="Customer ID" name="cid"><br><br>
          <button class = "button bt" input type="submit">Close Account</button>
        </form>
      </center>
      </div>
      </center>
