...
<html>
    ...
    <div class="sidenav">
      ...
      <center>
      <div class="container">
        <b><i>Create Account</i></b>
        <br><br>
        <center>
        <form action="acc_reg.php" method="POST">
            Account Type:<br> <select name="atype">
              <option>--------------Packages--------------</option>
              <option value="Yearly" >Yearly</option>
              <option value="Monthly" >Monthly</option>
              <option value="Weekly" >Weekly</option>
              </select><br><br>
            Customer ID:<br> <input type="number" placeholder="Customer ID" name="csid"><br><br>
          <button class = "button bt" input type="submit">Create Account</button>
        </form>
      </center>
      </div>
      </center>
